...
def main(cfg: DictConfig) -> None:
    ...
    config = run_folder + config_location_in_run_folder
    checkpoint_dir = run_folder + checkpoint_dirs_location_in_run_folder
    ...
    print(f"Testing agent in environment with config {config_file_path} and checkpoint dir {checkpoint_dir_path}.")
